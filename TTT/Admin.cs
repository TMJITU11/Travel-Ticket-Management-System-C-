...
namespace TTT
{
    public partial class Admin : Form
    {
        ...
        {
            string connectionString = @"Data Source=JITU\SQLEXPRESS;Initial Catalog=TMS;Integrated Security=True;";
        ...
        private void button_save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    // Recreate adapter with fresh connection
                    adapter = new SqlDataAdapter(currentQuery, conn);
